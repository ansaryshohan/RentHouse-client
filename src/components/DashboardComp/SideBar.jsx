...
const SideBar = () => {
  const { userRoleDataPending, userRoleDataError, isAdminData,refetch }= useAdmin();
  if(!userRoleDataPending){
    isAdminData ?<div className=" w-full">
  ...
  return (
    <div className=" w-full h-full  bg-primary-chocolate text-primary-light-chocolate flex flex-col justify-start items-center gap-6  pt-6 px-3">
      ...
      {
        !userRoleDataPending && isAdminData ?<>
        {/* admin route */}
